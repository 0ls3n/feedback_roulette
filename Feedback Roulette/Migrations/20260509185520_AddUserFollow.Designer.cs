...
namespace Feedback_Roulette.Migrations
{
    ...
    [Migration("20260509185520_AddUserFollow")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FeedbackRoulette_ClassLibrary.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Description = "Songwriting, mixing, mastering, and performance.",
                            Name = "Music"
                        },
                        new
                        {
                            Id = 2,
                            Description = "Code reviews, architecture, and logic.",
                            Name = "Programming"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("FeedbackRoulette_ClassLibrary.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FeedbackRoulette_ClassLibrary.UserFollow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FeedbackRoulette_ClassLibrary.UserStreak", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("StreakStartedAt")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("FeedbackRoulette_ClassLibrary.Notification", b =>
                {
                    b.HasOne("FeedbackRoulette_ClassLibrary.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FeedbackRoulette_ClassLibrary.UserFollow", b =>
                {
                    b.HasOne("FeedbackRoulette_ClassLibrary.ApplicationUser", "FollowedUser")
                        .WithMany()
                        .HasForeignKey("FollowedUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FeedbackRoulette_ClassLibrary.ApplicationUser", "FollowerUser")
                        .WithMany()
